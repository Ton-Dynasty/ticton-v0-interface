...
const Introduction = () => {
  ...
  return (
    <div className="backdrop-blur-lg">
      <div className="bg-star-left">
        <motion.section className="flex w-full flex-col items-center justify-center md:min-h-screen">
          <div className="flex w-full flex-col items-center justify-center gap-9">
            ...
            >
              Tic Ton oracle stands as the premier fully decentralized oracle on
              the TON platform. Diverging from market-standard final prices set
              by price providers, it employs Game Theory to craft a
              decentralized network of non-cooperative games. This network
              ascertains the ultimate price via mechanisms of arbitrage and
              bidirectional options, incorporating the chain with random data
